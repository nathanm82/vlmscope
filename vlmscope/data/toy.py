...
def toy_vqa() -> Dataset:
    ...
    samples = [
        Sample("q1", image_id="img1", question="What animal is this?",
               references=("cat", "cat", "kitten")),
        Sample("q2", image_id="img2", question="How many people are there?",
               references=("two", "2", "two people")),
        Sample("q3", image_id="img3", question="What color is the car?",
               references=("red", "red", "dark red")),
        Sample("q4", image_id="img4", question="Is it raining?",
               references=("no", "no", "no it is not")),
        Sample("q5", image_id="img5", question="What is the person doing?",
               references=("surfing", "surfing", "riding a wave")),
        Sample("q6", image_id="img6", question="Where is this?",
